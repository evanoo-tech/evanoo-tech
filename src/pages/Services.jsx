...
const services = [
  {
    ...
    points: ["SSR & static generation", "Core Web Vitals tuning", "CMS integrations"],
  },
  {
    Icon: Smartphone,
    ...
    points: ["React Native & Flutter", "Push notifications", "App Store & Play launch"],
  },
  {
    Icon: Boxes,
  ...
  },
  {
    ...
    points: ["React 19 / TanStack", "Design system & components", "State & data layer"],
  },
  {
    Icon: Cloud,
...
export default function Services() {
  return (
    <>
      ...
      >
        ...
        <div className="relative container mx-auto px-4 py-24 text-center sm:px-6 lg:px-8 lg:py-25">
          ...
          <p
            ...
            data-aos="fade-up"
          >
            From a single landing page to a multi-region platform, we cover
            the full product lifecycle — planned, shipped, and maintained.
          </p>
        </div>
      ...
      <section className="py-20 lg:py-20"> {/* bg-[#F7F7F5] */}
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3" data-aos="fade-down">
            {services.map(({ Icon, path, title, desc, points }) => (
              <article
                key={title}
                className="group relative flex flex-col overflow-hidden rounded-xl border border-border bg-card shadow-[0_1px_2px_rgba(11,18,32,0.04)] transition-all duration-200 hover:-translate-y-1 hover:border-[#38BDF8]/50 hover:shadow-[0_12px_30px_-12px_rgba(11,18,32,0.18)]">
                ...
                <div className="flex flex-1 flex-col p-7">
                  ...
                  <h2 className="mt-5 font-[Space_Grotesk,sans-serif] text-lg font-semibold text-black dark:text-white">
                    {title}
                  </h2>
                  ...
                  <ul className="mt-5 space-y-2 border-t border-border pt-4">
                    {points.map((p) => (
                      <li
                        key={p}
                        className="flex items-center gap-2 text-sm text-black/80 dark:text-muted-foreground"
                      >
      ...
      >
        ...
        <div className="relative container mx-auto px-4 py-20 text-center sm:px-6 lg:px-8 lg:py-24">
          ...
          <p
            className="mx-auto mt-3 max-w-xl text-md"
            style={{
              color:
                "color-mix(in oklch, var(--ink-foreground) 60%, transparent)",
            }}
